...
describe('uiWalletAccountsAreSame()', () => {
    ...
    it('returns false if the addresses match but the underlying `Wallet` does not', () => {
        const clonedMockUiWalletAccount = getOrCreateUiWalletAccountForStandardWalletAccount(
            { ...mockWallet },
            mockWalletAccount
        );
...
describe('uiWalletAccountBelongsToUiWallet()', () => {
    ...
    it('returns false if the UI wallet account does not belong to the UI wallet', () => {
        ...
        const identicalAccountInDifferentWallet = getOrCreateUiWalletAccountForStandardWalletAccount(
            differentWallet,
            mockWalletAccount
        );
